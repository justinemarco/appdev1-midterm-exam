            ...
            <nav id="tm-nav" className="fixed w-full">
                <div className="tm-container mx-auto px-2 md:py-6 text-right">
                    ...
                    <ul className="mb-3 md:mb-0 text-2xl font-normal flex justify-end flex-col md:flex-row">
                        ...
                        <li classNameName="inline-block mb-4 mx-4"><a href="#about" classNameName="tm-text-gold py-1 md:py-3 px-4">About</a></li>
                        <li classNameName="inline-block mb-4 mx-4"><a href="#contact" classNameName="tm-text-gold py-1 md:py-3 px-4">Contact</a></li>
                    </ul>
                </div>            
            </nav>
            <div classNameName="container mx-auto px-2 tm-intro-width">
                <div classNameName="sm:pb-60 sm:pt-48 py-20">
